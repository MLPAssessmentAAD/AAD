...
from tools.load_data_tmp import load_data
...
train_loader, val_loader, test_loader = load_data(mat_file, batch_size=batch_size)
...
model_test = load_best_model(model, path=best_model_path)
